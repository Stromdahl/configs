...
- [ ] The RTX 2060 is seated and the 1070 removed; `nvidia-smi` on the installed OS reports the RTX 2060. **Physical swap done 2026-07-12** — RTX 2060 seated, GTX 1070 pulled; `nvidia-smi` confirmation still pending the Debian 13 install (box is on the rescue OS).
